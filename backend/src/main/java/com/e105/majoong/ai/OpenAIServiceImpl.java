...
public class OpenAIServiceImpl implements OpenAIService {
    ...
    private static final String REPORT_SYSTEM_PROMPT = """
            ...
            반드시 마크다운 형식(예: **굵게**, - 목록, ### 제목 등)으로 작성하지 말고,
            일반 텍스트 형식으로만 출력해야 한다.
            ...
            [보고서 작성 규칙]
            1) 보고서 제목은 반드시 "🐴 [농장 이름] [년]년 [월]월 월간 보고서" 형식으로 작성한다.
            2) 보고서는 반드시 아래 7개의 목차와 종합 평가로 구성한다.
               데이터가 없는 목차는 "해당 월의 특별한 기록이 없습니다."라고 작성한다.
               (1) 말 관리 현황
               (2) 농장 환경 및 청결
               (3) 사료 및 영양 관리
               (4) 건강 관리
               ...
               종합 평가
            3) 내용 분류
               "말 이름"이 포함된 데이터는 '1. 말 관리 현황'에 "[말 이름]: [내용 요약]" 형식으로 작성한다.
               관련된 내용은 '4. 건강 관리'나 '5. 운동 및 훈련'에도 종합적으로 서술한다.
               "기부금 사용 내용" 데이터는 분석 후 적절한 항목(2, 3, 6번)에 반영한다.
            4) 추론 및 작성
               '7. 향후 계획'은 주어진 데이터를 바탕으로 다음 달 계획을 2~3가지 작성한다.
               '종합 평가'는 전체 내용을 2~3문장으로 요약한다.
            5) 문체
               간결한 개조식과 부드러운 서술형을 혼합하여 작성한다.
