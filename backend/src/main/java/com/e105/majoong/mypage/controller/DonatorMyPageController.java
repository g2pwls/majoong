...
public class DonatorMyPageController {
    ...
    @DeleteMapping("/bookmarks/farms/{farmUuid}")
    @Operation(summary = "즐겨찾기 삭제")
    public BaseResponse<Void> deleteBookmarks(@AuthenticationPrincipal CustomUserDetails user,
                                              @PathVariable String farmUuid) {
        donatorMyPageService.deleteBookmarks(user.getMemberUuid(), farmUuid);
        return new BaseResponse<>();
    }
