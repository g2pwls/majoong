...
public class DonateController {
  ...
  @PostMapping
  public ResponseEntity<DonationResponseDto> donate(@Valid @RequestBody DonationRequestDto req) throws Exception {
    return ResponseEntity.ok(donateService.donate(req));
  }
}
