...
const FARMS: Farm[] = [
  {
    ...
    horse_url: [
      "https://www.nhasfarmland.com/images/contents/horse/horse_p_01.jpg",
      "https://www.nhasfarmland.com/images/contents/horse/horse_p_014.jpg",
      "https://www.nhasfarmland.com/images/contents/horse/horse_p_019.jpg",
      "https://www.nhasfarmland.com/images/contents/horse/horse_p_020.jpg",
    ],
  },
];
  ...
  <div className="flex items-center gap-2 rounded-xl border px-2 py-1">
    <button
      ...
      className={`px-3 py-1 rounded-lg text-sm transition ${
        value === "farm" ? "bg-black text-white" : "hover:bg-muted"
      }`}
    ...
    <button
      ...
      className={`px-3 py-1 rounded-lg text-sm transition ${
        value === "horse" ? "bg-black text-white" : "hover:bg-muted"
      }`}
